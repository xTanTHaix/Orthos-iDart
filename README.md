...
# ⚡ Orthos-iDart
# Autonomous Python Execution Engine
...
[![CI Test Suite](https://img.shields.io/github/actions/workflow/status/xTanTHaix/Orthos-iDart/ci.yml?branch=main&style=for-the-badge&logo=githubactions&logoColor=white&label=CI%20BUILD)](https://github.com/xTanTHaix/Orthos-iDart/actions/workflows/ci.yml)
[![CodeQL Analysis](https://img.shields.io/github/actions/workflow/status/xTanTHaix/Orthos-iDart/codeql.yml?branch=main&style=for-the-badge&logo=github&logoColor=white&label=CodeQL)](https://github.com/xTanTHaix/Orthos-iDart/actions/workflows/codeql.yml)
[![OSV-Scanner](https://img.shields.io/github/actions/workflow/status/xTanTHaix/Orthos-iDart/osv-scanner.yml?branch=main&style=for-the-badge&logo=google&logoColor=white&label=OSV--Scanner)](https://github.com/xTanTHaix/Orthos-iDart/actions/workflows/osv-scanner.yml)
...
<table width="100%">
  <tr>
    <td align="left" bgcolor="#0f172a" colspan="2">
      <b>📥 Python Source Code / AST</b> <i>(Intercepted via sys.meta_path)</i>
    </td>
  </tr>
  <tr>
    <td align="left" bgcolor="#1e293b" colspan="2">
  ...
  <tr>
    <td width="70%" align="left" valign="top" bgcolor="#14532d">
    ...
    <td width="30%" align="left" valign="top" bgcolor="#7f1d1d">
  ...
  <tr>
    <td align="left" bgcolor="#059669" colspan="2">
